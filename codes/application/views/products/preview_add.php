		...
		<div class="product-container">
			<div class="product-info-container">
				<div class="product-header">
					...
					<p class="product-price">$<?= number_format((!empty($price)) ? $price : 0, 2) ?></p>
				</div>
				<div class="product-info">
					<div class="product-image-group">
						<img src="<?= $uploaded_images[$main_image ?? -1 ]  ?? "" ?>" alt="" class="product-image-main" />
						<div class="product-image-sub-container">
							<div class="product-image-sub" id="productImageSub"><!--
<?php						if (!empty($uploaded_images)) {
								foreach ($uploaded_images as $index => $url) {
									if($index != $main_image) { ?> 
